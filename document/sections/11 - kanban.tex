...
Il termine “kanban” spesso identifica anche la “kanban board”, che è il suo strumento di base, utilizzato anche in altri approcci agile. La kanban board consente di controllare il numero dei task in esecuzione (limit work-in-progress) massimizzando l’efficienza del “flusso” di lavoro(flow).\newline
